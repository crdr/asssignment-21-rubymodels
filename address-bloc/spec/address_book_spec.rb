...
RSpec.describe AddressBook do
    ...
    context "attributes" do
     ...
     context ".remove_entry" do
        it "removes an entry using the name, phone_number, and email address" do
            book.add_entry('Michael Faraday', '010.012.1255', 'michael.faraday@lovelace.com')
    ...
    context "importing from entries_2.csv" do
        ...
        it "imports the 1st entry" do
            book.import_from_csv("entries_2.csv")
            entry_one = book.entries[0]
            check_entry(entry_one, "Carmike", "616-255-9999","carmike@carmike.com")
        end
        
        it "imports the 2nd entry" do
            book.import_from_csv("entries_2.csv")
            entry_two = book.entries[1]
            check_entry(entry_two,"Georgie", "758-553-8888", "georgie@carmike.com")
        end
        
        it "imports the 3rd entry" do
            book.import_from_csv("entries_2.csv")
            entry_three = book.entries[2]
            check_entry(entry_three, "Sharon", "555-555-5555", "sharon@carmike.com")
        end
    end
